...
<div class="panel admin-panel">
    ...
    <form method="post" class="form-x" action="/health/management/Application/index.php/Admin/Hospital/editDep/hos_id/53/dep_id/2" name="fileUploadForm" enctype="multipart/form-data">
