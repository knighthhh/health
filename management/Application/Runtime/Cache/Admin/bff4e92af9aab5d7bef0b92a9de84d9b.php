...
<div class="panel admin-panel">
    ...
    <form method="post" class="form-x" action="/health/management/Application/index.php/Admin/Relative/edit/relative_id/4" name="fileUploadForm" enctype="multipart/form-data">
