...
<div class="panel admin-panel">
    ...
    <form method="post" class="form-x" action="/health/management/Application/index.php/Admin/doctor/edit/doc_id/46/hos_id/64" name="fileUploadForm" enctype="multipart/form-data">
